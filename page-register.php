            ...
            <ul class="form-fields">
                <li>
                    <dl class="clearfix">
                        ...
                        <dd class="span9"><input type="text" name="loginId" class="input_text" id="loginId" shc:gizmo:form="{required:true, pattern: /^\w+@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$/, message: 'Please enter a valid email address'}" /></dd>
                ...
                <li>
                    <dl class="clearfix">
                        ...
                        <dd class="span9">
                        	<input type="text" name="login_confirm-email" class="input_text" id="login_confirm-email" shc:gizmo:form="{required:true, custom: function() {}}" />
                        </dd>
                    </dl>
                </li>
                ...
                <li>
                    <dl class="clearfix">
                        ...
                        <dd class="span9"><input type="text" name="zipcode" class="input_text input_password" id="zipcode" shc:gizmo:form="{required:true, pattern: /(^\d{5})(-\d{4})?$/, message: 'Please enter a valid ZIP code'}" /></dd>
                    </dl>
                </li>
