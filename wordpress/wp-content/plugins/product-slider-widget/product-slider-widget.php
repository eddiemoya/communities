<?php
/*
Plugin Name: Product Slider Widget
Description: Display Product Slider
Version: 1.0
Author: Jason Corradino, Eddie Moya, Matt Day
License: GPL2
...
class Product_Slider_Widget extends WP_Widget {
	 ...
	 * @var string [REQUIRED]
	 */
	var $widget_name = 'Product Slider';
	 ...
	 */
	var $id_base = 'product_slider_widget';
	 ...
	 * @var string [OPTIONAL]
	 */
	private $description = 'Shows a slider of products';
	 ...
	 * @var string [OPTIONAL]
	 */
	private $classname = 'product-slider-widget';
	...
	public function widget( $args, $instance ){
		...
		extract($instance);
		echo $before_widget;
		include(locate_template("widgets/product-slider/slider.php"));
		echo $after_widget;
	}
...
Product_Slider_Widget::register_widget();
