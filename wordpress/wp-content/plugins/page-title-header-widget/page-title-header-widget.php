...
/*
Plugin Name: Page Title Header Widget
Description: Page title header
Version: 1.0
Author: Dan Crimmins & Tim Steele
*/
class Page_Title_Header_Widget extends WP_Widget {
     ...
     * @var string [REQUIRED]
     */
    var $widget_name = 'Page Title Header Widget';
     ...
     */
    var $id_base = 'page-title-header_widget';
     ...
     * @var string [OPTIONAL]
     */
    private $description = 'Page Title Header Widget';
