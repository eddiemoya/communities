	...
	<div id="new-reply-<?php bbp_topic_id(); ?>" class="bbp-reply-form">
		...
		<form id="new-post" name="new-post" method="post" action="<?php the_permalink(); ?>">
			...
			<fieldset class="bbp-form">
				<span id="reply-form-title">Reply</span>
				...
				<div>
					...
					<?php else : ?>
						<span id="forums-reply-box-label">Post</span>
					...
					<div class="bbp-submit-wrapper">
						...
						<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_reply_submit" name="bbp_reply_submit" class="<?php echo theme_option('brand');?>_button button submit"><?php _e( 'Submit Post', 'bbpress' ); ?></button>
