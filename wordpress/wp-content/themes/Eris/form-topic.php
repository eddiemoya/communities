			...
			<fieldset class="bbp-form">
				...
				<div>
					...
					<?php if ( current_user_can( 'moderate' ) ) : ?>
						...
						<input type="hidden" name="bbp_stick_topic" id="bbp_stick_topic" value="unstick" />
						<!--  <p>
					...
					<div class="bbp-submit-wrapper">
						...
						<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_topic_submit" name="bbp_topic_submit" class="sears_button button submit"><?php _e( 'Submit Post', 'bbpress' ); ?></button>
