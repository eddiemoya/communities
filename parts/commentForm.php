...
<?php
        ...
        $args = array(
            ...
            'comment_field'        => '<textarea id="comment-answer_textarea" class="input_textarea discussion" name="comment" shc:gizmo:form="{required:true, trim:true, custom: function(self) { if(self.value.length >= 3) return true; else return false;}, message:\'Please enter at least 3 characters.\'}">'. $comment_value .'</textarea>',
            'must_log_in'          => null,
            'logged_in_as'         => null,
