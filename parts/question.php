			...
			<section class="content-body clearfix">
				...
				<div class="span10">
					...
					<div class="content-details clearfix">
						<time class="content-date" pubdate datetime="<?php echo date( "Y-m-d", $post_date ); ?>"><?php echo date( "F j, Y", $post_date ); ?><span class="time-stamp"><?php echo date( "g:ia", $post_date ); ?></span></time>
					</div>
