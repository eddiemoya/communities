    ...
    <section class="span8 profile">
        ...
        <section class="personal_info clearfix">
            ...
            <dl class="span12 vitals">
                ...
                <dt>Birthday</dt>
                <dd><time class="content-date" datetime="<?php echo (isset($user_profile['dob']) && ! empty($user_profile['dob'])) ? date( "Y-m-d", strtotime($user_profile["dob"])) : ''; ?>" pubdate="pubdate"><?php echo (isset($user_profile['dob']) && ! empty($user_profile['dob'])) ? date( "F j, Y", strtotime($user_profile["dob"])) : 'n/a'; ?></time></dd>
            </dl>
