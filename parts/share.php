...
<div class="addthis_toolbox addthis_default_style">
    ...
    <a onclick="javascript:window.open('http://shopyourway.com/sharer/share?title=<?php echo $encoded_title; ?>&amp;link=<?php echo urlencode( $url ); ?>&amp;sourceSiteUrl=&amp;sourceSiteAlias=&amp;content=&amp;imageUrl=<?php echo $encoded_image; ?>','ShopYourWay','width=650,height=350'); return false;" style="cursor:pointer;"><img src="<?php echo get_template_directory_uri() ?>/assets/img/shopyourway_large.png" /></a>
...
<ul class="addthis dropmenu">
    <li>
        ...
        <ul class="sharemenulinks">
            ...
            <li><a onclick="javascript:window.open('http://shopyourway.com/sharer/share?title=<?php echo $encoded_title; ?>&amp;link=<?php echo urlencode( $url ); ?>&amp;sourceSiteUrl=&amp;sourceSiteAlias=&amp;content=&amp;imageUrl=<?php echo $encoded_image; ?>','ShopYourWay','width=650,height=350'); return false;" style="cursor:pointer;"><img src="http://static.shopyourway.com/static/share-buttons/small-light.png" alt=""/>ShopYourWay</a></li>
