...
require_once($wp_admin . 'includes/comment.php');
require_once($wp_admin . 'includes/list-table.php');
require_once($wp_admin . 'includes/class-wp-list-table.php');
require_once($wp_admin . 'admin.php');
...
require_once($wp_admin . '/admin-header.php');
?>
...
include($wp_admin . '/admin-footer.php'); ?>
